...
\usepackage{url}
\usepackage{nopageno}
\usepackage[bottom=0.0in, top = 0.75in, left = 1.0in, right = 1.0in]{geometry}
\usepackage{paralist}
...
%\hfill \emph{\footnotesize{Source code for this resume can be found on github.com/tonyp2121/Resume}}
% source code on a resume might be a bit much
\end{document}
